...
fh = open(fname)
lst = list()
for line in fh:               # list for the desired output               # to read every line of file romeo.txt
    word= line.split()    # to eliminate the unwanted blanks and turn the line into a list of words
